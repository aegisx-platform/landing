    ...
    <section class="hero">
      <div class="hero__container">
        ...
        <div class="hero__actions">
          <a href="https://github.com/AegisX/aegisx-ui" target="_blank" class="hero__btn hero__btn--primary">
          ...
          <a href="#pricing" class="hero__btn hero__btn--secondary">
            <svg class="hero__btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <div class="hero__visual">
        <div class="hero__code-preview">
          ...
          <pre class="hero__code-content"><code><span class="hero__code-prompt">$</span> npm install aegisx-ui
