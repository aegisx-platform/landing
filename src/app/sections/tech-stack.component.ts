    ...
    <section class="tech-stack" id="tech-stack">
      <div class="tech-stack__container">
        ...
        <div class="tech-stack__main">
          <a href="https://angular.dev" target="_blank" class="tech-stack__main-logo">
            <img src="assets/logos/angular_wordmark_white.png" alt="Angular" />
            <span>Frontend</span>
          </a>
          <div class="tech-stack__main-plus">+</div>
          <a href="https://fastify.dev" target="_blank" class="tech-stack__main-logo">
          ...
          <div class="tech-stack__grid">
            @for (tech of frontendStack; track tech.name) {
              <div class="tech-stack__card" [style.--accent-color]="tech.color">
                <div class="tech-stack__card-icon" [innerHTML]="tech.icon"></div>
    ...
    this.frontendStack = [
      {
        ...
        color: '#dd0031',
        icon: this.sanitizer.bypassSecurityTrustHtml(`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M9.93 12.645h4.134L12.003 8.19l-2.073 4.455zM12 0L1.5 4.2l1.6 14.1L12 24l8.9-5.7 1.6-14.1L12 0zm6.65 18.4h-2.4l-1.275-3.225H8.975L7.7 18.4H5.35L12 2.1l6.65 16.3z"/></svg>`)
      },
      {
        name: 'AegisX UI',
        description: 'Custom component library',
        color: '#6366f1',
        icon: this.sanitizer.bypassSecurityTrustHtml(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>`)
      },
      {
      ...
      },
      {
        ...
        color: '#06b6d4',
        icon: this.sanitizer.bypassSecurityTrustHtml(`<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 6c-2.7 0-4.35 1.35-4.95 4.05.99-1.35 2.145-1.86 3.465-1.53.75.19 1.29.735 1.89 1.335C13.33 10.785 14.46 12 17.1 12c2.7 0 4.35-1.35 4.95-4.05-.99 1.35-2.145 1.86-3.465 1.53-.75-.19-1.29-.735-1.89-1.335C15.77 7.215 14.64 6 12 6zM6.9 12c-2.7 0-4.35 1.35-4.95 4.05.99-1.35 2.145-1.86 3.465-1.53.75.19 1.29.735 1.89 1.335.93.93 2.07 2.145 4.71 2.145 2.7 0 4.35-1.35 4.95-4.05-.99 1.35-2.145 1.86-3.465 1.53-.75-.19-1.29-.735-1.89-1.335C10.68 13.215 9.54 12 6.9 12z"/></svg>`)
      }
    ];
    ...
    this.backendStack = [
      {
        ...
        color: '#ffffff',
        icon: this.sanitizer.bypassSecurityTrustHtml(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>`)
      },
      {
        name: 'PostgreSQL',
        description: 'Robust database',
        color: '#336791',
        icon: this.sanitizer.bypassSecurityTrustHtml(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg>`)
      },
      {
        name: 'Knex.js',
        description: 'SQL query builder',
        color: '#e26522',
        icon: this.sanitizer.bypassSecurityTrustHtml(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 6h16M4 12h16M4 18h7"/></svg>`)
      },
      {
        name: 'TypeBox',
        description: 'Runtime validation',
        color: '#3178c6',
        icon: this.sanitizer.bypassSecurityTrustHtml(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg>`)
      }
    ];
