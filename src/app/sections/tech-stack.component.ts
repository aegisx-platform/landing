      ...
      <div class="tech-stack__container">
        ...
        <div class="tech-stack__main">
          ...
          <a href="https://fastify.dev" target="_blank" class="tech-stack__main-logo">
            <img src="assets/logos/fastify-square.svg" alt="Fastify" class="tech-stack__fastify" />
            <span>Backend</span>
          </a>
        </div>
  ...
  frontendStack: TechItem[] = [
    {
      ...
      icon: `<svg viewBox="0 0 24 24" fill="currentColor">
        <path d="M9.93 12.645h4.134L12.003 8.19l-2.073 4.455zM12 0L1.5 4.2l1.6 14.1L12 24l8.9-5.7 1.6-14.1L12 0zm6.65 18.4h-2.4l-1.275-3.225H8.975L7.7 18.4H5.35L12 2.1l6.65 16.3z"/>
      </svg>`
    },
    {
      name: 'Signals',
    ...
    },
    {
      ...
      color: '#06b6d4',
      icon: `<svg viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 6c-2.7 0-4.35 1.35-4.95 4.05.99-1.35 2.145-1.86 3.465-1.53.75.19 1.29.735 1.89 1.335C13.33 10.785 14.46 12 17.1 12c2.7 0 4.35-1.35 4.95-4.05-.99 1.35-2.145 1.86-3.465 1.53-.75-.19-1.29-.735-1.89-1.335C15.77 7.215 14.64 6 12 6zM6.9 12c-2.7 0-4.35 1.35-4.95 4.05.99-1.35 2.145-1.86 3.465-1.53.75.19 1.29.735 1.89 1.335.93.93 2.07 2.145 4.71 2.145 2.7 0 4.35-1.35 4.95-4.05-.99 1.35-2.145 1.86-3.465 1.53-.75-.19-1.29-.735-1.89-1.335C10.68 13.215 9.54 12 6.9 12z"/>
      </svg>`
    }
  ];
