      ...
      <div class="showcase__container">
        ...
        <div class="showcase__header">
          ...
          <h2 class="showcase__title">
            Theme Builder
            <span class="showcase__title-accent">Visual M3 Color Generator</span>
          </h2>
          <p class="showcase__subtitle">
            Create stunning Material Design 3 themes visually.
            Generate color schemes, preview in real-time, and export to CSS/SCSS instantly.
          </p>
        </div>
        ...
        <div class="showcase__preview">
          <div class="showcase__preview-header">
            <div class="showcase__preview-dots">
              <span class="showcase__preview-dot showcase__preview-dot--red"></span>
              <span class="showcase__preview-dot showcase__preview-dot--yellow"></span>
              <span class="showcase__preview-dot showcase__preview-dot--green"></span>
            </div>
            <span class="showcase__preview-title">Theme Builder - AegisX UI</span>
          </div>
            ...
            <div class="showcase__palette">
              <div class="showcase__palette-section">
                ...
                <div class="showcase__palette-colors">
                  <div class="showcase__palette-color" style="background: #6366f1"></div>
                  <div class="showcase__palette-color" style="background: #818cf8"></div>
                  <div class="showcase__palette-color" style="background: #a5b4fc"></div>
                  <div class="showcase__palette-color" style="background: #c7d2fe"></div>
                  <div class="showcase__palette-color" style="background: #e0e7ff"></div>
                </div>
              </div>
              <div class="showcase__palette-section">
                <span class="showcase__palette-label">Secondary</span>
                <div class="showcase__palette-colors">
                  <div class="showcase__palette-color" style="background: #a855f7"></div>
                  <div class="showcase__palette-color" style="background: #c084fc"></div>
                  <div class="showcase__palette-color" style="background: #d8b4fe"></div>
                  <div class="showcase__palette-color" style="background: #e9d5ff"></div>
                  <div class="showcase__palette-color" style="background: #f3e8ff"></div>
                </div>
              </div>
              <div class="showcase__palette-section">
                <span class="showcase__palette-label">Tertiary</span>
                <div class="showcase__palette-colors">
                  <div class="showcase__palette-color" style="background: #ec4899"></div>
                  <div class="showcase__palette-color" style="background: #f472b6"></div>
                  <div class="showcase__palette-color" style="background: #f9a8d4"></div>
                  <div class="showcase__palette-color" style="background: #fbcfe8"></div>
                  <div class="showcase__palette-color" style="background: #fce7f3"></div>
                </div>
              </div>
            </div>
            <!-- Theme Mode Toggle -->
        ...
        <div class="showcase__features">
          @for (feature of features; track feature.title) {
            <div class="showcase__feature-card">
              <div class="showcase__feature-icon" [style.background]="feature.gradient" [innerHTML]="feature.icon"></div>
        ...
        <div class="showcase__export">
          <div class="showcase__export-header">
            ...
            <div class="showcase__export-tabs">
              <button class="showcase__export-tab showcase__export-tab--active">CSS</button>
              <button class="showcase__export-tab">SCSS</button>
            </div>
          </div>
          <pre class="showcase__export-code"><code><span class="showcase__code-comment">/* AegisX Theme - Generated by Theme Builder */</span>
...
{{'}'}}
        ...
        <div class="showcase__cta">
          <a href="https://github.com/AegisX/aegisx-ui" target="_blank" class="showcase__btn showcase__btn--primary">
          ...
          <span class="showcase__cta-note">Part of AegisX UI - MIT License</span>
        </div>
      </div>
    </section>
  `,
